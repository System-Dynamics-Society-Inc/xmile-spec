...
* Image message:  `+<image>+` as described in <<sec-graphics-frames>>

* Video message:  `+<video>+` as described in <<sec-graphics-frames>>

* Sound attached to message:  `+<sound>+` as described in <<sec-buttons>>

* Hyperlink to a place to navigate to:  `+<link>+`, as described in <<sec-buttons>>.
