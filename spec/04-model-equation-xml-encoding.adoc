...
* AI status:  `+ai_state="…"+` attribute w/a single-letter code recording how AI contributed to this variable, as described in <<sec-ai-variable-status>> (default: none)
...
* Image message:  `+<image>+` as described in <<sec-media-and-navigation-objects>>

* Video message:  `+<video>+` as described in <<sec-media-and-navigation-objects>>

* Sound attached to message:  `+<sound>+` as described in <<sec-media-and-navigation-objects>>

* Hyperlink to a place to navigate to:  `+<link>+`, as described in <<sec-media-and-navigation-objects>>.
