...
The following attributes are supported on `+<status>+`. Additional attributes MAY be included as long as they follow the rules for signature generation described in <<sec-ai-signing>>.
