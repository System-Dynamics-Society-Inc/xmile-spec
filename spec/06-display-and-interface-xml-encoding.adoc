...
[[sec-switches-and-radio-buttons-option-groups]]
...
* Switch appearance OPTIONAL:  `+switch_style="…"+` with either `+toggle+` or `+push_button+` (default: `+toggle+`)

* Make a sound when clicked OPTIONAL:  `+clicking_sound="…"+` with true/false (default: `+false+`)
...
Descriptions of all other display attributes of a switch can be found in <<sec-stock-and-flow-diagram-objects>>.
...
[[sec-numeric-inputs-and-list-input-devices]]
...
Descriptions of all other display attributes of a numeric input can be found in <<sec-stock-and-flow-diagram-objects>>.
...
* Name of the input page REQUIRED:  `+name="…"+` with page name (default: none)

* Numeric column width REQUIRED:  `+column_width="…"+` with width in model coordinates; the name column width is the remaining width of the list input (default: half the width of the list input)
...
Descriptions of all other display attributes of a graphical input can be found in <<sec-stock-and-flow-diagram-objects>>.
